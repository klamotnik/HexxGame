...
namespace Hexx.Components.Panels
{
    public class RegisterForm : Form
    {
        ...
        public RegisterForm(Rectangle rectangle, OnSubmit callbackOnSubmit, OnCancel callbackOnCancel) : base(rectangle, callbackOnSubmit, callbackOnCancel)
        {
            ...
            submitButton = new Button((0, 114, 80, 32), "Submit", "Register", Submit);
        ...
        private RegisterRequest GenerateRegisterRequest()
        {
            ...
            registerRequest.Login = (string)loginField.Value;
            registerRequest.Password = Convert.ToBase64String(new SHA512Managed().ComputeHash(new UTF8Encoding().GetBytes((string)passwordField.Value)));
