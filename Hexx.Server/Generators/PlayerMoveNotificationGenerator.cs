...
{
    public class PlayerMoveNotificationGenerator : NotificationGenerator<TableChangeNotification>
    {
        private int tableNumber;
        private NotificationAction action;

        public PlayerMoveNotificationGenerator(Request request, Response response) : base(request, response)
        {
        }
